...
static const Pair device_pairs[] = {
...
StitchContext::set_parameters (ContextParams &param_list)
{
    ...
    parse_enum (param_list, device_pairs, "device", _device);
    ...
    if (_device == RenderD128)
        _node_name = "/dev/dri/renderD128";
    else if (_device == RenderD129)
        _node_name = "/dev/dri/renderD129";
    else if (_device == Card0)
