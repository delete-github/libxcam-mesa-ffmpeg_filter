...
public:
    ...
    XCamReturn init_dmabuf (const SmartPtr<GLStitcher::StitcherParam> &param);
...
XCamReturn
StitcherImpl::init_dmabuf (const SmartPtr<GLStitcher::StitcherParam> &param)
{
